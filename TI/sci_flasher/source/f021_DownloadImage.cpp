...
void loadProgram_checksum(FILE *fh)
{
	...
	char c_temp;
	// c_temp = getc(fh);
	// QUIETPRINT(_T("[0]:%lx,"), c_temp);
	c_temp = getc(fh);
	QUIETPRINT(_T("[1]:%lx,"), c_temp);
#endif
