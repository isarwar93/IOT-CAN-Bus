...
sudo /home/ismail/IOT-CAN-Bus/TI/sci_flasher/build/serial_flash_programmer -p /dev/ttyUSB1 -b 115200 -d f2837xD -a firmware_cpu1.txt -k F2837xD_sci_flash_kernels_cpu01.txt -m F2837xD_sci_flash_kernels_cpu02.txt -n firmware_cpu2.txt -q
